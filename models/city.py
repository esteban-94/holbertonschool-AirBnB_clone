...
class City(BaseModel):
    """
    This class inherits from the BaseModel class and represents a city within a state.
    ...
    - updated_at: datetime - the date and time when the instance was last updated,
                  set using the datetime.now() method.
    - state_id: str - the unique identifier of the state that the city belongs to.
    - name: str - the name of the city.

    Methods:
    - __init__(*args, **kwargs) -> None
        This method is called when an instance of the class is created.
        It initializes the instance's attributes id, created_at, updated_at, state_id, and name.

    - __str__() -> str
        This method returns a string representation of the instance.
        The string includes the instance's class name, id, state_id, and name attribute.
