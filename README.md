# Python - holbertonschool-AirBnB_clone
...
### Console Commands :space_invader:
...
* **class**
  * Usage: `<class>.<method>(<attributes>)`.

As you see the past examples you can use the class to call every methods implemented.

```
(hbnb) Place.create()
0003264a-17b0-42f8-9a48-c95eb4b440a6
(hbnb) 
```
